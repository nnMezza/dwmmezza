...
static const char *fonts[] = {"DMMono-Regular:size = 16"};
static const char dmenufont[] = "DMMono-Regular:size = 16";
static const char col_black[] = "#121111";
...
static const char *colors[][3] = {
    ...
    [SchemeLt] = {col_gray4, col_black, col_gray2},
    [SchemeSel] = {col_gray4, col_blue, col_blue},
};
static const char *tagsel[][2] = {
    {col_blue, col_black}, {col_red, col_black}, {col_yellow, col_black},
    {col_cyan, col_black}, {col_magenta, col_black}, {col_cyan, col_black},
};
...
/* tagging */
static char *tags[] = {"cmd", "www", "dev", "sys"};
static char *alttags[] = {"[cmd]",  "[www]", "[dev]", "[sys]"};
...
static const char *dmenucmd[] = {"dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_black, "-nf", col_gray3, "-sb", col_blue, "-sf", col_gray4, NULL};
